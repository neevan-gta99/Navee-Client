...
function AddLuggage() {
  ...
  return (
    <div>
      <h1 className='mt-20'>Add Luggage</h1>
      <br /><br />
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <select {...register("brand", { required: "Brand is required" })} defaultValue="">
          ...
          {luggageBrands.map(brand => <option key={brand} value={brand}>{brand}</option>)}
        </select>
        <br /><br />
        <br />
        ...
        <select {...register("material")} defaultValue="">
          ...
          {luggageMaterials.map(material => <option key={material} value={material}>{material}</option>)}
        </select>
        <br /><br />
