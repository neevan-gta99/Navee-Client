...
function AddBoysBrands() {

  const topwearSubcategories = ["T-Shirt", "Shirt", "Jacket"];
  const bottomwearSubcategories = ["Jeans", "Shorts", "Trousers", "Pants"];
  ...
  return (
    <div>
      <h1 className='mt-20'>Add Boys Clothing & Footwear</h1>
      <br /><br />
