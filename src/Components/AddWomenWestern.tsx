...
function AddWomenWestern() {
  ...
  const onSubmit = async (data: any) => {
    ...
    Object.entries({
      ...data,
      sellerID: sellerID,
      gender: "Female", // Gender updated to Female
      collection: category, 
    ...
    try {
      // Updated API endpoint to women-western
      const response = await fetch("http://localhost:6173/api/addProduct/women-western", {
        method: "POST",
        body: formData,
        credentials: "include",
      });
  ...
  return (
    <div>
      <h1 className='mt-20'>Add Women's Western Wear</h1>
      <br /><br />
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <select {...register("sleeve")} defaultValue="">
          ...
          <option value="Spaghetti Strap">Spaghetti Strap</option>
        </select>
        <br /><br />
...
export default AddWomenWestern;